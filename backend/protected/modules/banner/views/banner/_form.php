...
<tbody>
  ...
  <?php echo $form->textAreaRow($model, 'pagelist', array('hint' => 'Каждая страница на новой строке<br/>"*" - любое сочетание символов.')); ?>
  <?php echo $form->textAreaRow($model, 'pagelist_exc', array('hint' => 'Каждая страница на новой строке<br/>"*" - любое сочетание символов.')); ?>
